...
const UserCard = ({ user, onToggle }) => {
  ...
  return (
    <div
      className="bg-gray-800 border-gray-700 hover:shadow-[0_8px_30px_rgb(0,0,0,0.4)] rounded-xl p-6 w-80 flex flex-col items-center border transition-all duration-300 backdrop-blur-sm"
    >
      <div className="relative mb-4 group">
        <div
          className="absolute inset-0 rounded-full bg-blue-500 blur-md opacity-20 group-hover:opacity-30 transition-opacity"
        ></div>
        <img
